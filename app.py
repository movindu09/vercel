...
def test():
    ...
    return render_template("VocalReplacement.html")
...
def analyze():
    ...
    return render_template('Analysis-Results.html', mid_value=mid_value, low_value=low_value, high_value=high_value,
